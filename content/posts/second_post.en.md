...
1. **Supplementary admission deadlines have been removed** – this is a super important change! Don't miss the main window, because there is no second chance in the same year anymore.
2. An option to supplement your portfolio with a **GRE** test score has been added, which can save your skin if your GPA is borderline. Remember, however, that the first filter remains the GPA at around 75% and an appropriate number of ECTS credits from the required prerequisite courses.
3. Achievements related to research activities are taken into account, as well as professional experience.
4. Recommendation letters are only required when applying for 6 specific programs.
5. A motivation letter is still crucial to stand out – and an important note: **write it yourself, using AI can very easily disqualify you.**
6. The required English level is still **C1**, but the university can be ruthless towards international students: **[only CAE, CPE, IELTS, or TOEFL certificates are accepted](https://www.dtu.dk/english/education/graduate/admission-and-deadlines/application_procedure/apply/language-test-requirements#english-language-tests)**. An International or European Baccalaureate will also be fine. 
7. All documents from foreign countries must strictly be translated by a professional translator (preferably into English or Danish).
...
👉 **ALWAYS check the details directly at the source:** 1. [Official DTU admission page](https://www.dtu.dk/english/education/graduate/admission-and-deadlines) 
2. [Required documents](https://www.dtu.dk/english/education/graduate/admission-and-deadlines/application_procedure/apply/required-documents)
